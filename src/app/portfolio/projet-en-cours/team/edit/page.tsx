...
import Profile from '@/app/portfolio/projet-en-cours/team/edit/navigation/Profile';
import PersonalInfoLocation from '@/app/portfolio/projet-en-cours/team/edit/navigation/PersonalInfoLocation';
import Contacts from '@/app/portfolio/projet-en-cours/team/edit/navigation/Contacts';
import Role from '@/app/portfolio/projet-en-cours/team/edit/navigation/Role';
import Equipment from '@/app/portfolio/projet-en-cours/team/edit/navigation/Equipment';
import Skills from '@/app/portfolio/projet-en-cours/team/edit/navigation/Skills';
...
const sections = [
  ...
  { id: 'skills', label: 'Compétences', icon: UserIcon, shortLabel: 'Compétences' },
];
...
function EquipePageContent() {
  ...
  const [teamMember, setTeamMember] = useState<ProjectTeamMember>({
    ...
    equipment: {
      internet: 'wifi',
      phones: [{ model: '', isPublic: true }],
      computers: [{ os: 'windows', ram: '', storage: '', gpu: '', isPublic: true }]
    },
    location: {
      country: '',
      city: '',
    ...
    try {
      ...
      if (profile) {
        ...
        setTeamMember({
          ...
          skillsPublic: profile.skillsPublic !== undefined ? profile.skillsPublic : true,
  ...
  const handleSave = async () => {
    ...
    const firstPhone = teamMember.equipment?.phones?.[0];
    if (!firstPhone?.model?.trim()) {
      errors.push("Modèle de téléphone principal");
    }
        ...
        <div className={styles.pageContainer}>
          <div className={styles.projectTitleRow}>
            <h1 className={styles.projectTitle}>
              {projectTitle ? `Mon Profil - ${projectTitle}` : 'Mon Profil'}
            </h1>
          </div>
          ...
          <header className={styles.header}>
            ...
            <div className={styles.headerActions}>
              <button
                ...
                title="Retour à la vue d'équipe"
              >
                <UserIcon size={16} />
                <span className={styles.buttonText}>Équipe</span>
              </button>
